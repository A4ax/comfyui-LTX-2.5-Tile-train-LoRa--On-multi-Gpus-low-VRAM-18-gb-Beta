...
def _record(load_times_path: str | None, component: str, load_s: float) -> None:
    """Append a per-model load time to the shared load_times.jsonl (best-effort)."""
    if not load_times_path:
        return
    try:
        p = Path(load_times_path)
...
def main(  # noqa: PLR0913
    ...
    compute_latents(
        ...
        overwrite=overwrite,
        load_times_path=load_times_path,
    )
